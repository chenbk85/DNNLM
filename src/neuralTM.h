...
{
    char map_input_digits, map_output_digits;
...
public:
    ...
    void set_map_digits(char value) { map_input_digits = map_output_digits = value; }
    void set_map_input_digits(char value) { map_input_digits = value; }
    void set_map_output_digits(char value) { map_output_digits = value; }
    ...
    int lookup_input_word(const std::string &word) const
    {
	        ...
	        if (isdigit(word[i]))
		{
		    ...
		    for (; i<word.length(); i++)
		        if (isdigit(word[i]))
			    mapped_word[i] = map_input_digits;
    ...
    int lookup_output_word(const std::string &word) const
    {
	        ...
	        if (isdigit(word[i]))
		{
		    ...
		    for (; i<word.length(); i++)
		        if (isdigit(word[i]))
			    mapped_word[i] = map_output_digits;
